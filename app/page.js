  ...
  return (
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8">
        <h1 className="text-4xl md:text-6xl lg:text-7xl text-[#279AF1] font-semibold  mb-6">
          Your Space to Reflect. <br /> Your Story to Tell.
        </h1>
        <p className="text-lg md:text-xl text-[#23B5D3] mb-8">
        ...
        <div className="flex justify-center gap-4">
          <Link href="/dashboard">
            <Button
              variant="journal"
              className="px-8 py-6 rounded-full flex items-center gap-2 transition-all delay-400 ease-in-out hover:scale-105"
            >
          ...
          <Link href="#features">
            <Button
              variant="outline"
              className="px-8 py-6 rounded-full border-blue-600 text-blue-600 transition-all delay-400 ease-in-out hover:scale-105 hover:bg-blue-100"
            >
              Learn More
            </Button>
          </Link>
      ...
      <div className="mt-24">
        <Card className="bg-gradient-to-r from-blue-100 to-amber-100">
          <CardContent className="p-12 text-center">
            ...
            <Button size="lg" variant="journal" className="transition-all delay-400 ease-in-out hover:scale-105">
